...
;window.RevColor={defaultValue:"#ffffff",isColor:/(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i,get:function(b){return b?RevColor.process(b,!0)[0]:"transparent"},parse:function(b,k,l){b=RevColor.process(b,!0);var m=[];m[0]=k?k+": "+b[0]+";":b[0];l&&(m[1]=b[1]);return m},convert:function(b,k){if(!b||"string"!==typeof b)return RevColor.defaultValue;if("transparent"===b)return b;if(-1!==b.search(/\[\{/)||-1!==b.search("gradient")||"undefined"===typeof k||isNaN(k))return RevColor.process(b,!0)[0];k=parseFloat(k);
...
b.search("#")?[RevColor.sanitizeHex(b),"hex"]:-1!==b.search("rgba")?[b.replace(/\s/g,"").replace(/false/g,"1"),"rgba"]:-1!==b.search("rgb")?[b.replace(/\s/g,""),"rgb"]:RevColor.isColor.test(b)?[b,"hex"]:["transparent","transparent",!0]},transparentRgba:function(b,k){return k||"rgba"===RevColor.process(b)[1]?"0"===RevColor.rgbValues(b,4)[3]:!1},rgbValues:function(b,k){b=b.substring(b.indexOf("(")+1,b.lastIndexOf(")")).split(",");3===b.length&&4===k&&(b[3]="1");for(var l=0;l<k;l++)b[l]=b[l].trim();
return b},rgbaString:function(b,k,l,m){return"rgba("+b+", "+k+", "+l+", "+m+")"},rgbToHex:function(b){b=RevColor.rgbValues(b,3);return RevColor.getRgbToHex(b[0],b[1],b[2])},rgbaToHex:function(b){b=RevColor.rgbValues(b,4);return[RevColor.getRgbToHex(b[0],b[1],b[2]),b[3]]},getOpacity:function(b){return parseInt(100*RevColor.rgbValues(b,4)[3],10)+"%"},getRgbToHex:function(b,k,l){return"#"+("0"+parseInt(b).toString(16)).slice(-2)+("0"+parseInt(k).toString(16)).slice(-2)+("0"+parseInt(l).toString(16)).slice(-2)},
joinToRgba:function(b){b=b.split("||");return RevColor.convert(b[0],b[1])},processRgba:function(b,k){b=b.replace("#","");var l="undefined"!==typeof k,m=(l?"rgba":"rgb")+"("+parseInt(b.substring(0,2),16)+", "+parseInt(b.substring(2,4),16)+", "+parseInt(b.substring(4,6),16);return m=l?m+(", "+(.01*parseInt(k,10)).toFixed(2).replace(/\.?0*$/,"")+")"):m+")"},processGradient:function(b){var k=b.type,l="linear"===k?b.angle+"deg, ":"ellipse at center, ";b=b.colors;for(var m=b.length,B="",u,y=0;y<m;y++)0<
y&&(B+=", "),u=b[y],B+="rgba("+u.r+", "+u.g+", "+u.b+", "+u.a+") "+u.position+"%";return k+"-gradient("+l+B+")"},sanitizeHex:function(b){b=b.replace("#","").trim();if(3===b.length){var k=b.charAt(0),l=b.charAt(1);b=b.charAt(2);b=k+k+l+l+b+b}return"#"+b},sanitizeGradient:function(b){for(var k=b.colors,l=k.length,m=[],B,u=0;u<l;u++){var y=k[u];delete y.align;B?JSON.stringify(y)!==JSON.stringify(B)&&(m[m.length]=y):m[m.length]=y;B=y}b.colors=m;return b}};
(function(b){function k(){this.innerHTML=T[this.getAttribute("data-text")||""]}function l(){this.setAttribute("placeholder",T[this.getAttribute("data-placeholder")||""])}function m(){this.setAttribute("data-message",T[this.getAttribute("data-alert")||""])}function B(a){a||(a={});"string"===typeof a&&(a=JSON.parse(a.replace(/\&/g,'"')));T=b.extend({},wa,a);Va=T.color;p.find("*[data-placeholder]").each(l);p.find("*[data-alert]").each(m);p.find("*[data-text]").each(k)}function u(a,c,d,e){if(b.isPlainObject(a)){var f;
for(f in a)if(a.hasOwnProperty(f)){a=a[f];if("string"===typeof a){a=RevColor.process(a);if("gradient"===a[1]){var h=a[2];var ga=h.angle;var r=h.type}a=a[0]}else ga=a.angle,r=a.type;var g=isNaN(f)?f.replace(/_/g," ").replace(/\b\w/g,function(a){return a.toUpperCase()}):"radial"!==r?ga+"&deg;":"radial"}}else g=a;if("blank"!==a)return b.isPlainObject(a)&&(h=a,a=e||RevColor.processGradient(a)),a='<span class="rev-cpicker-color tptip'+d+'" data-title="'+g+'" data-color="'+a+'"><span class="rev-cpicker-preset-tile"></span><span class="rev-cpicker-preset-bg" style="background: '+
...
!0),q.addClass("selected"),!1}function O(a,c,b){if(A){a||(c=c||t.val(),b="undefined"!==typeof b?b:w.val(),c="transparent"===c?"transparent":"100%"===b?RevColor.sanitizeHex(c):RevColor.processRgba(c,b));var d=(b="transparent"===c)?"":c;a?H.data("state",c):C.data("state",c);b?A.css("background",d):A[0].style.background=d;za&&za(n,c);I.trigger("revcolorpickerupdate",[n,c])}}function ya(a,c){var d=RevColor.process(a),e=d[1],f=d[0];ja&&J.removeClass("checked");if("gradient"!==e){switch(e){case "hex":a=
RevColor.sanitizeHex(f);w.val("100%");U(100);break;case "rgba":var d=RevColor.rgbaToHex(f),h=parseInt(100*d[1],10);a=d[0];w.val(h+"%");U(h);break;case "rgb":a=RevColor.rgbToHex(f);w.val("100%");U(100);break;default:ka.click(),C.click()}K.val(a).change();c||C.click()}else if(ja){d=d[2];h=d.angle;"radial"===d.type&&(h="radial");P.removeClass("selected");b('.rev-cpicker-orientation[data-direction="'+h+'"]').addClass("selected");z.val(Aa(h));Xa(h);for(var d=d.colors,h=document.createDocumentFragment(),
ga=d.length,r,g,k=0;k<ga;k++)g=d[k],r=g.align,h.appendChild(Ya(r,g.position,Za(g),$a(g,r)));Q&&Q.draggable("destroy");L.empty().append(h);Q=L.children().draggable(V);x();c||(ab=!0,H.click())}else K.val(RevColor.defaultValue).change(),C.click();return[f,e]}function bb(a,c){a:{var d=v.slice();var e=d.length;for(d.sort(Ba);e--;){var f=d[e];if(f.align===a&&f.x<c){d=f;break a}}for(var e=d.length,h=0;h<e;h++)if(f=d[h],f.align===a&&f.x>c){d=f;break a}d=void 0}e=d.color;d=$a(e,a,!0);e=Za(e,!0);d=Ya(a,c,e,
d);g&&g.removeClass("active");g=b(d).addClass("active").appendTo(L).draggable(V);la=g.children(".rev-cpicker-point-square")[0];ma=g.children(".rev-cpicker-point-triangle")[0];Q=L.children();e=cb(c);x(d);"bottom"===a&&R.val(e[1]).change()}function cb(a){"undefined"===typeof a&&(a=v[na].x);var b=g.attr("data-color"),d=g.hasClass("rev-cpicker-point-bottom");if(d)E.hasClass("active")&&(W.attr("disabled","disabled"),M.attr("disabled","disabled"),E.removeClass("active")),b=RevColor.rgbaToHex(b)[0],X.css("background",
b),N.removeAttr("disabled").val(a+"%"),2<p.find(".rev-cpicker-point-bottom").length&&F.addClass("active"),p.addClass("open");else{F.hasClass("active")&&(X.css("background",""),N.attr("disabled","disabled"),F.removeClass("active"));var e=RevColor.getOpacity(b);W.attr("data-opacity",e).val(e).removeAttr("disabled");M.val(a+"%").removeAttr("disabled");2<p.find(".rev-cpicker-point-top").length&&E.addClass("active");p.removeClass("open")}return[d,b]}function $a(a,b,d){return"bottom"===b?"rgb("+a.r+","+
...
e+'"></span>':'<span class="rev-cpicker-point-square" style="background: '+e+'"></span><span class="rev-cpicker-point-triangle" style="border-top-color: '+e+'"></span>';return f}function Aa(a){a&&"radial"!==a||(a="0");Ca.innerHTML=a+"&deg;";return Ca.value}function db(){g&&(g.removeClass("active"),g=!1);N.attr("disabled","disabled");W.attr("disabled","disabled");M.attr("disabled","disabled");E.removeClass("active");F.removeClass("active");X.css("background","");p.removeClass("open")}function Da(a,
b){p.removeClass("active is-basic").hide();Y.removeClass("rev-colorpicker-open");Z.css({left:"",top:""});oa&&(oa.remove(),oa=!1);q?(q.hasClass("selected")?(b&&n.data("hex",q.attr("data-color").toLowerCase()),q.removeClass("selected")):n.removeData("hex"),q=!1):n.removeData("hex");b||(Ea&&Ea(),G&&"transparent"!==G?A[0].style.background=G:A.css("background",""),I.trigger("revcolorpickerupdate",[n,G]));n=A=!1}function Fa(){var a=b(this).children(".rev-cpicker-color").not(".blank").length;6<a?b("#"+this.id+
"-btn").addClass("multiplerows"):b("#"+this.id+"-btn").removeClass("multiplerows");return a}function Bb(){for(var a=b(this),c=-1!==this.id.search("colors")?5:6,a=a.children(".rev-cpicker-color"),d=a.length,e=Math.ceil(d/6),c=6*c,f,d=d+1,h=0;h<e;h++){var g=6*h,g=a.slice(g,parseInt(g+6,10)-1);Ga=!0;g.each(Cb);Ga&&(d-=6,d>=c&&(g.remove(),f=!0))}return f}function Cb(){if(-1===this.className.search("blank"))return Ga=!1}function x(a,b,d){Ha=b;eb();Ha=!1;for(var c,f=[],h=v.length,g=0;g<h;g++)c=v[g],b=c.color,
f[g]=b,c=c.el,c.setAttribute("data-color",RevColor.rgbaString(b.r,b.g,b.b,b.a)),c.setAttribute("data-opacity",100*b.a),a&&a===c&&(na=g);fb.hasClass("selected")?(D.type="radial",D.angle="0"):(D.type="linear",D.angle=parseInt(z.val(),10).toString());D.colors=f;q&&q.removeClass("selected");a=RevColor.processGradient(D);O(!0,a);if(d)return[D,a];d=gb.style;f=a.replace("radial-","linear-");f=f.split("(");b=f[0];f.shift();f=f.join("(").split(",");f.shift();b=b+"(90deg,"+f.join(",");d.background=b;pa.style.background=
a}function hb(a,b){if(0===a)return!1;for(var c;a--;)if(c=v[a],c.align!==b)return c;return!1}function ib(a,b,d){if(a===d)return!1;for(var c;a++<d;)if(c=v[a],c.align!==b)return c;return!1}function Ia(a,b,d,e,f){return Math.max(Math.min(Math.round(Math.abs((a-b)/(d-b)*(f-e)+e)),255),0)}function eb(){v=[];aa=[];ba=[];Q.each(Db);v.sort(Ba);for(var a=v.length,b=a-1,d,e,f,h,g=0;g<a;g++)if(d=v[g],f=d.align,e=hb(g,f),!1===e&&(e=ib(g,f,b)),h=ib(g,f,b),!1===h&&(h=hb(g,f)),"bottom"===f){f=d;var r=e.alpha,k=h.alpha;
r!==k?(e=e.x,h=Math.max(Math.min(Math.abs(parseFloat(((f.x-e)/(h.x-e)*(k-r)).toFixed(2))+parseFloat(r)),1),0).toFixed(2)):h=r;f.alpha=h;f.color.a=h}else f=d.color,k=e.color,r=h.color,e!==h?(d=d.x,e=e.x,h=h.x,f.r=Ia(d,e,h,k.r,r.r),f.g=Ia(d,e,h,k.g,r.g),f.b=Ia(d,e,h,k.b,r.b)):(f.r=k.r,f.g=k.g,f.b=k.b);v.sort(Ba)}function Ba(a,b){return a.x<b.x?-1:a.x>b.x?1:0}function Db(a){var b=RevColor.rgbValues(this.getAttribute("data-color")||"",4),d=-1!==this.className.search("bottom")?"bottom":"top",e=b[3].replace(/\.?0*$/,
"")||0,f=parseInt(this.style.left,10);Ha&&(f=50>f?f+2*(50-f):f-2*(f-50),this.style.left=f+"%",this.setAttribute("data-location",f));v[a]={el:this,x:f,alpha:e,align:d,color:{r:parseInt(b[0],10),g:parseInt(b[1],10),b:parseInt(b[2],10),a:e,position:f,align:d}};g&&g[0]!==this&&("bottom"===d?ba[ba.length]=f:aa[aa.length]=f)}function Xa(a){a="undefined"!==typeof a?a:parseInt(z.val(),10);jb[0].style.transform="rotate("+a+"deg)"}function Ja(a,c,d){var e="undefined"!==typeof d;d=e?d:parseInt(z.val(),10);if(a&&
"keyup"===a.type){var f=!isNaN(d)&&-360<=d&&360>=d;var h=d}else{a=parseInt(z.data("orig-value"),10);d||(d="0");if(isNaN(d)||-360>d||360<d)d=a;d!==a&&(h=d,f=!0,z.val(Aa(d)),e||(d=c||d,P.removeClass("selected"),b('.rev-cpicker-orientation[data-direction="'+d+'"]').addClass("selected")))}if(f||c)h&&Xa(h),x()}function kb(){var a=b(this);-1!==this.className.search("down")?(a.parent().addClass("active"),a.closest(".rev-cpicker-presets").addClass("active"),b(this.id.replace("-btn","")).addClass("active"),
qa=p.hasClass("gradient-view")):(a.parent().removeClass("active"),a.closest(".rev-cpicker-presets").removeClass("active"),b(this.id.replace("-btn","")).removeClass("active"),qa=!1)}function Eb(a,b){var c=parseInt(100*(Math.round(b.position.left)/263).toFixed(2),10);"bottom"===Ka?N.val(c+"%").trigger("keyup"):M.val(c+"%").trigger("keyup")}function Fb(){var a=b(this);Ka=a.hasClass("rev-cpicker-point-bottom")?"bottom":"top";a.click()}function Gb(){"bottom"===Ka?N.trigger("focusout"):M.trigger("focusout")}
...
I=b(document);V.drag=Eb;V.stop=Gb;V.start=Fb;C.data("state",ob.find(".rev-cpicker-color").eq(0).attr("data-color")||"#ffffff");H.data("state",nb.find(".rev-cpicker-color").eq(0).attr("data-color")||"linear-gradient(0deg, rgba(255, 255, 255, 1) 0%, rgba(0, 0, 0, 1) 100%)");Z.draggable({containment:"window",handle:".rev-cpicker-draggable",stop:function(){Z.css("height","auto")}});S.perfectScrollbar({wheelPropagation:!1,suppressScrollX:!0});ca.on("mousedown.revcpicker",function(a){P.removeClass("selected");
Qa=!0;lb(a)}).on("mousemove.revcpicker",function(a){Qa&&lb(a)}).on("mouseleave.revcpicker mouseup.revcpicker",function(){Qa=!1});b(".rev-cpicker-main-btn").on("click.revcpicker",function(){xa=-1===this.id.search("gradient");if(A){var a=b(this);a=a.data("state")}xa?(A&&(ia=t.val()),p.removeClass("gradient-view").addClass("color-view")):(A&&(ia=a),p.removeClass("color-view").addClass("gradient-view"),ab||Pa.children(".rev-cpicker-color").not(".blank").eq(0).click());S.perfectScrollbar("update");if(a){var c=
"transparent"===a,d=c?"":a;c?A.css("background",d):A[0].style.background=d;ha=!0;b(".rev-cpicker-color").not(".blank").each(y);ha=!1;I.trigger("revcolorpickerupdate",[n,a])}});b("#rev-cpicker-check").on("click.revcipicker",function(){if(p.hasClass("color-view")){var a=t.val();var c=w.val();n.removeData("gradient");a="transparent"===a?"transparent":"100%"===c?RevColor.sanitizeHex(a):RevColor.processRgba(a,c);c=[n,a,!1]}else{db();a=x(!1,!1,!0);c=b.extend({},a[0]);var d=a[1];n.data("gradient",d);a=JSON.stringify(c).replace(/\"/g,
"&");c=[n,d,c]}if(d=c[1]!==G)n.attr("data-color",c[1]).val(a).change(),I.trigger("revcolorpicker",c),Ra&&Ra(c[0],c[1],c[2]);Da(!1,d)});p.on("click.revcpicker",function(a){if(p.hasClass("open")){var c=a.target;a=b(c);var d=c.id;(c=-1!==c.className.search("rev-cpicker-point")||"rev-cpicker-section-right"===d||-1!==d.search("hit")||a.closest("#rev-cpicker-section-right, #rev-cpicker-point-wrap").length)&&("text"===a.attr("type")?c=!a.attr("disabled"):"rev-cpicker-check-gradient"===d&&(c=!1));c||db()}else Sa&&
...
height:250,border:!1,hide:!1,change:function(a,b){var c=b.color.toString();this.value=c;ra.val(c);X.css("background",c);la.style.backgroundColor=c;ma.style.borderBottomColor=c;var c=RevColor.processRgba(c,100),e=RevColor.rgbValues(c,4),f=D.colors[na];f.r=e[0];f.g=e[1];f.b=e[2];f.a=e[3];g.attr("data-color",c);x()}});Ma.slider({orientation:"vertical",max:180,value:180,start:function(){pb="transparent"===t.val()},slide:function(a,b){if(!La){var c=parseInt(100*(b.value/180).toFixed(2),10);if(pb){var e=
c?"#ffffff":"transparent";t.val(e)}0===c&&(e="transparent");O(!1,e,c||"transparent");w.val(c+"%")}}});b(".rev-cpicker-point-location").on("keyup.revcpicker focusout.revcpicker",function(a){if(g){var b=g.hasClass("rev-cpicker-point-bottom")?"bottom":"top",d="bottom"===b?ba:aa,b="bottom"===b?N:M,e=b.val().replace("%","")||"0";a=a.type;var f;isNaN(e)&&(e="keyup"===a?"0":g.attr("data-location"));e=Math.max(0,Math.min(100,parseInt(e,10)));for(f=50>e?1:-1;-1!==d.indexOf(e);)e+=f;"focusout"===a&&(b.val(e+
"%"),g.attr("data-location",e));g.css("left",e+"%");x()}}).on("focusin.revcpicker",da);b("body").on("click.revcpicker",".rev-cpicker-point",function(){L.find(".rev-cpicker-point.active").removeClass("active");g=b(this).addClass("active");la=g.children(".rev-cpicker-point-square")[0];ma=g.children(".rev-cpicker-point-triangle")[0];x(this);q=!1;var a=cb();a[0]&&R.val(a[1]).change()}).on("mousedown.revcpicker",".rev-cpicker-point",function(a){g=b(this).data("mousestart",a.pageY)}).on("mousemove.revcpicker",
function(a){if(g&&g.data("mousestart")){var b=g.data("mousestart");a=a.pageY;g.hasClass("rev-cpicker-point-bottom")?a>b&&15<a-b&&F.hasClass("active")?g.addClass("warning"):g.removeClass("warning"):b>a&&15<b-a&&E.hasClass("active")?g.addClass("warning"):g.removeClass("warning")}}).on("mouseup.revcpicker",function(a){if(g&&g.data("mousestart")){var b=g.data("mousestart");a=a.pageY;g.removeData("mousestart");g.hasClass("rev-cpicker-point-bottom")?a>b&&10<a-b&&F.hasClass("active")?F.click():g.removeClass("warning"):
b>a&&10<b-a&&E.hasClass("active")?E.click():g.removeClass("warning")}}).on("change.revcpicker",".rev-cpicker-component",function(){var a=b(this),c=a.data("gradient")||a.val()||"transparent";if("transparent"===c||RevColor.transparentRgba(c))c="";a.data("tpcp").css("background",c)}).on("keypress.revcpicker",function(a){p.hasClass("active")&&(a=a.which,27==a?Da():13==a&&ta&&ta.blur())}).on("click.revcpicker",".rev-cpicker-color:not(.blank)",function(){if(q){if(q[0]===this&&q.hasClass("selected"))return;
q.removeClass("selected")}q=b(this);var a=q.parent()[0].id,c=-1!==a.search("core")?"core":"custom",a=-1!==a.search("colors")?"colors":"gradients",c=b("#rev-cpicker-"+a+"-"+c+"-btn");c.hasClass("active")&&c.find(".rev-cpicker-arrow-up").click();p.hasClass("color-view")?(c=q.attr("data-color"),Ta=!0,K.val(c).change(),"transparent"===t.val()&&t.val(c.toLowerCase()),Ta=!1,a=w.val(),0===parseInt(a,10)&&(c="transparent"),O(!1,c,a)):(ea.removeClass("full"),sa.removeClass("full"),ya(q.data("gradient"),!0),
J.removeClass("checked"),Pa.find(".rev-cpicker-color.selected").removeClass("selected"));q.addClass("selected")}).on("mouseover.revcpicker",".rev-cpicker-color:not(.blank)",function(){qa&&(pa.style.background=this.getAttribute("data-color")||"")}).on("mouseout.revcpicker",".rev-cpicker-color:not(.blank)",function(){qa&&x()}).on("click.revcpicker",".rev-cpicker-delete",function(){if(fa){if(window.confirm(document.getElementById("rev-cpicker-remove-delete").innerHTML)){p.addClass("onajax onajaxdelete");
var a=b(this),c=a.parent(),d=c.attr("data-title")||"";if(!d){console.log("Preset does not have a name/title");return}var e=a.closest(".rev-cpicker-presets-group")[0].id,f=-1!==e.search("colors")?"colors":"gradients";I.off("revcpicker_onajax_delete.revcpicker").on("revcpicker_onajax_delete.revcpicker",function(d,f){f&&console.log(f);var h=a.closest(".rev-cpicker-presets-group"),g=h.find(".ps-scrollbar-x-rail"),k=b("#"+e+"-btn");c.remove();Bb.call(h[0])?h.perfectScrollbar("update"):b('<span class="rev-cpicker-color blank"></span>').insertBefore(g);
7>Fa.call(h[0])&&(b('<span class="rev-cpicker-color blank"></span>').insertBefore(g),k.hasClass("active")&&k.children(".rev-cpicker-arrow-up").click());p.removeClass("onajax onajaxdelete")});d=b.trim(d.replace(/\W+/g,"_")).replace(/^\_|\_$/g,"").toLowerCase();fa("delete",d,f,"revcpicker_onajax_delete",n)}return!1}console.log("Ajax callback not defined")});b(".rev-cpicker-save-preset-btn").on("click.revcpicker",function(){if(fa){var a,c=b(this),d=c.closest(".rev-cpicker-presets-save-as").find(".rev-cpicker-preset-save").val();
if(d&&isNaN(d)){var e=p.hasClass("color-view")?"colors":"gradients";d=b.trim(d.replace(/\W+/g,"_")).replace(/^\_|\_$/g,"").toLowerCase();b("#rev-cpicker-"+e+"-custom").find(".rev-cpicker-color").not(".blank").each(function(){if(b.trim((this.getAttribute("data-title")||"").replace(/\W+/g,"_")).replace(/^\_|\_$/g,"").toLowerCase()===d)return alert(c.attr("data-message")),a=!0,!1});if(!a){p.addClass("onajax onajaxsave");var f={};if("colors"===e){var h=t.val();var g=w.val();h="transparent"===h?"transparent":
"100%"===g?RevColor.sanitizeHex(h):RevColor.processRgba(h,g)}else{var k=pa.style.background;h=b.extend({},x(!1,!1,!0)[0])}f[d]=h;I.off("revcpicker_onajax_save.revcpicker").on("revcpicker_onajax_save.revcpicker",function(a,d){if(d)p.removeClass("onajax onajaxsave"),alert(c.attr("data-message"));else{var h=b(u(f,!1," rev-picker-color-custom",k)),g=b("#rev-cpicker-"+e+"-custom"),r=g.find(".rev-cpicker-color.blank"),n=b("#"+g[0].id+"-btn");r.length?h.insertBefore(r.eq(0)):h.insertBefore(g.find(".ps-scrollbar-x-rail"));
b("#rev-cpicker-"+e+"-custom-btn").click();6<Fa.call(g[0])&&(r.length&&r.last().remove(),n.addClass("active").children(".rev-cpicker-arrow-down").click(),g.perfectScrollbar("update"));h.click();p.removeClass("onajax onajaxsave")}});fa("save",f,e,"revcpicker_onajax_save",n)}}else alert(c.attr("data-message"))}else console.log("Ajax callback not defined")});b(".rev-cpicker-preset-title").on("click.revcpicker",function(){var a=b(this),c=a.parent(),d=a.hasClass("active")?"down":"up";kb.call(a.find(".rev-cpicker-arrow-"+
d)[0]);c.find(".rev-cpicker-preset-title").removeClass("selected");a.addClass("selected");c.find(".rev-cpicker-presets-group").hide();document.getElementById(this.id.replace("-btn","")).style.display="block";S.perfectScrollbar("update")});ka.on("click.revcpicker",function(){w.val("0%");U(0);K.val(RevColor.defaultValue).change();t.val("transparent");O(!1,"transparent")});p.find('input[type="text"]').on("focusin.revcpicker",function(){ta=this}).on("focusout.revcpicker",function(){ta=!1});b(".rev-cpicker-input").on("focusin.revcpicker",
...
c)});b(".rev-cpicker-point-delete").on("click.revcpicker",function(){if(-1!==this.className.search("active")){var a=g.hasClass("rev-cpicker-point-bottom")?"bottom":"top",b=p.find(".rev-cpicker-point-"+a).length;2<b&&(g.draggable("destroy").remove(),Q=L.children(),p.click(),x());20>=b&&("bottom"===a?sa.removeClass("full"):ea.removeClass("full"))}});b(".rev-cpicker-preset-save").on("focusin.revcpicker",da);b(".rev-cpicker-opacity-input").on("keyup.revcpicker focusout.revcpicker",function(a){var c=-1===
this.id.search("grad"),d=c?w:W,e=d.val().replace("%","");a=a.type;isNaN(e)&&(e="keyup"===a?"0":b(this).data("orig-value"));e=Math.max(0,Math.min(100,e));"focusout"===a&&(d.val(e+"%"),c||g.attr("data-opacity",e));c?(c=parseInt(e,10),O(!1,0!==c?!1:"transparent",e),U(e)):(c=RevColor.rgbValues(g.attr("data-color"),3),d=D.colors[na],e=(.01*parseInt(e,10)).toFixed(2).replace(/\.?0*$/,""),d.r=c[0],d.g=c[1],d.b=c[2],d.a=e,c=RevColor.rgbaString(d.r,d.g,d.b,e),g.attr("data-color",c),x(),c="rgba(0, 0, 0, "+
e+")",la.style.backgroundColor=c,ma.style.borderTopColor=c)}).on("focusin.revcpicker",da);b(".rev-cpicker-builder-hit").on("click.revcpicker",function(a){v||eb();a=parseInt(100*((a.pageX-ea.offset().left)/265).toFixed(2),10);for(var b=-1!==this.id.search("bottom")?"bottom":"top",d="bottom"===b?ba:aa,e=50>a?1:-1;-1!==d.indexOf(a);)a+=e;"bottom"===b?20>p.find(".rev-cpicker-point-bottom").length?(bb(b,a),q=!1):sa.addClass("full"):20>p.find(".rev-cpicker-point-top").length?(bb(b,a),q=!1):ea.addClass("full")});
J.on("click.revcpicker",function(){J.hasClass("checked")?J.removeClass("checked"):J.addClass("checked");x(!1,!0)});b(".rev-cpicker-arrow").on("click.revcpicker",kb);qb=!0}function rb(a){var c=b.extend({},a);a=c.core||{};var c=c.custom;if(!sb||c){var d=4;c=(sb=c)||{colors:[],gradients:[]}}else d=2;a.colors||(a.colors=ua);a.gradients||(a.gradients=va);for(var e=0;e<d;e++){switch(e){case 0:var f="colors-core";var h=a.colors;break;case 1:f="gradients-core";h=a.gradients;break;case 2:f="colors-custom";
h=c.colors;break;case 3:f="gradients-custom",h=c.gradients}var g=f;var k=h.slice()||[];for(var p=document.createDocumentFragment(),n=-1!==g.search("core"),q=n?"":" rev-picker-color-custom",l=k.length,m=-1!==g.search("colors")?5:6,l=Math.max(Math.ceil(l/6),m),m=0;m<l;m++)for(;k.length<6*(m+1);)k[k.length]="blank";l=k.length;for(m=0;m<l;m++)p.appendChild(u(k[m],n,q));g=["rev-cpicker-"+g,p];k=b("#"+g[0]);k.find(".rev-cpicker-color").remove();k.prepend(g[1])}}var I,z,qb,Y,ja,v,fb,ea,za,tb,fa,p,Na,J,H,
ra,Ua,ta,ub,vb,X,C,t,N,R,Ga,g,oa,Pa,Ea,wb,xb,Ka,aa,ba,sa,Ca,la,ma,K,Va,gb,Ha,Qa,Oa,xa,ca,jb,pa,ka,P,na,M,ab,Sa,W,Q,L,nb,F,T,sb,yb,ia,n,S,ob,w,G,Wa,zb,A,Ta,ha,qa,pb,Z,E,q,Ma,La,mb,Ab,Ra,D={},V={axis:"x",containment:"#rev-cpicker-point-wrap"},wa={color:"Color",solid_color:"Solid Color",gradient_color:"Gradient Color",currently_editing:"Currently Editing",core_presets:"Core Presets",custom_presets:"Custom Presets",enter_a_name:"Enter a Name",save_a_new_preset:"Save a new Preset",save:"Save",color_hex_value:"Color Hex Value",
...
"string"===typeof a?this.each(Ib[a]):this.each(function(){var c=b(this);if(c.hasClass("rev-cpicker-component"))c.tpColorPicker("refresh");else{var d=b('<span class="rev-colorpicker"></span>').data("revcolorinput",c),e=b('<span class="rev-colorbox" />'),f=b('<span class="rev-colorbtn" />'),h=c.attr("data-wrap-classes"),g=c.attr("data-wrapper"),k=c.attr("data-wrap-id"),p=c.attr("data-title"),n=c.attr("data-skin"),l=c.val()||"";var m=l;m=/(?=.*false)(?=.*rgba)/.test(m)?m.replace("false","1"):!1;m&&(l=
m,c.val(m));d.insertBefore(c).append([e,f,c]);if(a&&b.isPlainObject(a)){g||(g=a.wrapper);h||(h=a.wrapClasses);n||(n=a.skin);k||(k=a.wrapId);p||(p=a.title);var q=a.defaultValue;(m=c.data("revcp"))&&(a=b.extend({},m,a));c.data("revcp",a)}h||(h=Ab);h&&d.addClass(h);k&&d.attr("id",k);l||(l=q||RevColor.defaultValue,c.val(l));h=RevColor.process(l);l=h[0];3===h.length&&c.val(l);h="rgba"===h[1]&&RevColor.transparentRgba(l,!0)?"":l;"transparent"!==h&&(e[0].style.background=h);f[0].innerHTML=p||Va||wa.color;
c.attr({type:"hidden","data-color":l}).data("tpcp",e).addClass("rev-cpicker-component");n&&d.addClass(n);g?(g=b(g).addClass("rev-cpicker-master-wrap"),d.wrap(g)):d.addClass("rev-cpicker-master-wrap");(e=a?a.init||tb:!1)&&e(d,c,l,a)}})};b(function(){b("body").on("click.revcpicker",".rev-colorpicker",function(){qb||Hb();n=b(this).data("revcolorinput");var a=n.attr("data-widget-id"),c=n.attr("data-appended-html"),d=n.attr("data-editing"),e=n.attr("data-colors"),f=n.attr("data-mode"),h=n.data("revcp"),
g=n.attr("data-lang"),k;if(e){e=JSON.parse(e.replace(/\&/g,'"'));if(e.colors)var l=e.colors;if(e.gradients)var m=e.gradients}if(h){if(k=h.colors){if(k.core){var q=k.core.colors;var t=k.core.gradients}if(k.custom){var u=k.custom.colors;var v=k.custom.gradients}}var w=h.onEdit;var x=h.onAjax;k=h.change;var z=h.cancel;g||(g=h.lang);f||(f=h.mode);c||(c=h.appendedHtml);d||(d=h.editing);a||(a=h.widgetId)}if(t||q||v||u||m||l){h={};if(t||q||m||l)h.core={colors:l||q||ua,gradients:m||t||va};if(v||u)h.custom=
{colors:u||ua,gradients:v||va};rb(h)}a||(a=yb);a&&(p[0].id=a);c||(c=zb);c&&(oa=b(c).appendTo(Z));g&&B(g);f||(f=Ua);d?Oa.style.visibility="visible":(d="",Oa.style.visibility="hidden");mb.innerHTML=d;"single"===f||"basic"===f?(ja=!1,H.hide(),C.show(),"basic"===f&&p.addClass("is-basic")):(ja=!0,H.show(),C.show());a=n.val()||n.attr("data-color")||RevColor.defaultValue;1<a.split("||").length&&(a=RevColor.joinToRgba(a),n.val(a));a=ya(a);G=a[0];za=w||ub;fa=x||vb;Ea=z||wb;Ra=k||xb;"gradient"!==a[1]?C.data("state",
G):H.data("state",G);Y.addClass("rev-colorpicker-open");A=n.data("tpcp");p.data("revcpickerinput",n).addClass("active").show();S.each(Fa).perfectScrollbar("update");Wa=n.attr("data-color");ia=n.data("hex");b(".rev-cpicker-color").not(".blank").each(y)})})})("undefined"!==jQuery?jQuery:!1);